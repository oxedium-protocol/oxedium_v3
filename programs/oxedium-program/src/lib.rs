...
pub mod oxedium_program {
    ...
    pub fn update_vault(ctx: Context<UpdateVaultInstructionAccounts>, base_fee_bps: u64, protocol_fee_bps: u64, max_age_price: u64) -> Result<()> {
        instructions::admin::update_vault(ctx, base_fee_bps, protocol_fee_bps, max_age_price)
    }
